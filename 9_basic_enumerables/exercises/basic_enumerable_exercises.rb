...
def find_absolute_values(numbers)
  ...
  numbers.map do |numbers| numbers.abs
  end
...
def find_longer_words(word_list, base_word)
  ...
  word_list.reduce([]) do |accumulator, current_word|
...
def find_word_lengths(word_list)
  ...
  # hint: use a new hash or an empty hash as the initial accumulator 
  word_list.reduce({}) do |accumulator, word| accumulator.update(word => word.length) 
  end
